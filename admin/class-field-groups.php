...
',
					...
					array(
						...
						'label'             => $this->slug_prepend ? 'Slug / Hidden' : 'Slug',
						...
						'wrapper'           => array(
							'width' => '',
							'class' => $this->slug_prepend ? 'child-field hide-title' : '',
							'id'    => '',
						),
						'default_value'     => '',
						'placeholder'       => '',
						'prepend'           => $this->slug_prepend ? $this->slug_prepend : '/',
						'append'            => '',
						'maxlength'         => '',
						'readonly'          => 0,
						'disabled'          => 0,
			...
			'supports' => array(
				...
				'fields'                => array(
					array(
						...
						'default_value'     => array( 'title', 'editor' ),
						'layout'            => 'vertical',
						'toggle'            => 0,
					),
				),
